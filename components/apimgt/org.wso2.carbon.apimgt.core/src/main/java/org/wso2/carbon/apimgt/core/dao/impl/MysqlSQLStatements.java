 ...
 */
public class MysqlSQLStatements implements ApiDAOVendorSpecificStatements, StreamDAOVendorSpecificStatements {
    ...
    @Override
    public String getStoreAPIsByLabelJoinQuery(int labelCount) {
        return null;
    }
